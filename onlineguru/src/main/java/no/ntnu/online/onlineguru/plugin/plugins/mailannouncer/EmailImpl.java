...
public class EmailImpl implements Email {
    ...
    public Boolean announceEmail(String toEmail, String fromEmail, String subject, String listId) {
        ...
        if (announceHashMap.containsKey(getLookup(toEmail, listId))) {
            ...
            // trims subject & replace multiple whitespaces between words with single blank
            toAnnounce.setSubject(subject.trim().replaceAll("\\b\\s{2,}\\b", " ")); // not stored when saving settings..
